// show/hide the password in modal log in
...
//heart button - add to favorites when clicked
var i = 0;
...
//hide filters on landing page - on mobile
...
// get stored values to cart items from local storage
...
// add to cart only one item from hover functionality
...
//load more products - button - home page
function loadMore() {
     $.ajax({
...
//load more products - button - landing page
...
// thumnail made main picture when clicked
...
// read more button - show no more than 100 characters
$(document).ready(function(){
  var maxLength = 100;
...
// scroll to top button - product page mobile
